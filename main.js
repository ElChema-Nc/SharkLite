...
//   rl.close();
// }}
console.log('Escriba el número que será propietario, ejemplo: +505 0000 0000')
console.log('Si piensa agregar varios números separados por ",", ejemplo: +505 0000 0000, +505 0000 0000, +505 0000 000')
...
/*console.log('Escriba el número que será propietario, ejemplo: +505  0000 0000')
console.log('Si piensa agregar varios números separé por "," ejemplo: +505 0000 0000, +505 0000 0000, +505 0000 000')
...
if (opts['autocleartmp'] && (global.support || {}).find) (tmp = [os.tmpdir(), 'tmp', "SharkLiteJadiBot"], tmp.forEach(filename => cp.spawn('find', [filename, '-amin', '2', '-type', 'f', '-delete'])))}, 30 * 1000)}
...
const directories = ['./SharkSession/', './SharkLiteJadiBot/']
