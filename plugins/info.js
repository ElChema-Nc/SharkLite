...
description = official[1][0] == String(contact[0]) ? 'Solo temas del SharkLite' : desc === '' ? lenguajeGB.smsContacto4() : desc
correo = official[1][0] == String(contact[0]) ? 'ja82783643@gmail.com' : mail === '' ? lenguajeGB.smsContacto5() : mail
